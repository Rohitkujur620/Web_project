<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql_insert = "INSERT INTO `orders` (`name`, `phone`, `email`, `address_1`, `address_2`, `product`, `quantity`, `size`) VALUES ('$name', '$phone', '$email', '$address_1', '$address_2', '$product', '$quantity', '$size');";
